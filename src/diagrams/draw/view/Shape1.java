...
public class Shape1 extends StackPane {
	SVGPath path = null;

	public Shape1()
	{
		SVGPath path1 = new SVGPath();
		path1.setContent("m0 0l50 50l 0 -50 l -50 0");
		Text text = new Text("Heart");
		getChildren().addAll(path1, getHeartPath(), text);
	}
	
	
	static public SVGPath getHeartPath()
	{
		SVGPath path2 = new SVGPath();
		path2.setContent(getHeartPathStr());
		return path2;
	}
	static public String getHeartPathStr()
	{
