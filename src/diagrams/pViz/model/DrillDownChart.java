...
public class DrillDownChart extends VBox
{
	...
	private final GeneListController controller;


	public DrillDownChart(GeneListController ctlr, ObservableList<DimensionRecord> observableList)
	{
		this(ctlr);
//		addData(observableList);
	}
	public DrillDownChart(GeneListController ctlr)
	{
		controller = ctlr;
		addLayer("X", "Y", 0);
